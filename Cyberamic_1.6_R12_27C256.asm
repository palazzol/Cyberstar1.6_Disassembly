...
8066: fd 01 3e     std (0x013E)         ; store this vector here?
...
8098: bd 86 c4     jsr (0x86C4)         ; main1?
...
80c1: fc 04 0b     ldd (0x040B)         ; security code??
...
; do subroutines based on bits in 0x0401???
